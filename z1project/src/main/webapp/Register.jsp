...
<input type ="reset" value = "Clear" style ="margin-left: 30px"/></center><br>
<label Style = "margin-left: 30px;">already a user please login</label><a href = "Login.jsp" style = "margin-left: 25px;">Login</a>
</form>
</div>
</body>
</html>